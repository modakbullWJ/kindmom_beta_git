  ...
  <div class="inner">
        <div class="service">
            <ul>
                ...
                <li class="mintsale"><a href="<?php echo G5_SHOP_URL ?>/">착한엄마 SHOP</a></li>
...
<!--
         ...
         <div class="lnb">
             ...
             <ul id="mainnav">
                 ...
                 <li class="txtColorPink" id="dropMenu"><a href="#">요리·맛집</a>
                 ...
                 <li class="txtColorPink" id="dropMenu"><a href="#">육아</a>
                 ...
                 <li class="txtColorPink" id="dropMenu"><a href="#">러브</a>
                 ...
                 <li class="txtColorPink" id="dropMenu"><a href="#">라이프</a>
                 ...
                 <li class="" id="dropMenu"><a href="#">뉴스</a>
