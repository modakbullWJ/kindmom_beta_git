...
<aside id="stv">
    <div id="stv_list">
        ...
        <ul id="stv_nb">
            ...
            <li><a href="<?php echo G5_SHOP_URL; ?>/orderinquiry.php"><img src="<?php echo G5_THEME_URL; ?>/img/shop/delivery.png" alt="주문/배송조회"></a></li>

        </ul>
      <div id="ft_totop">
         <a href="#"><img src="<?php echo G5_THEME_URL; ?>/img/shop/to_top.png" alt="상단으로"></a>
      </div>
    </div>
